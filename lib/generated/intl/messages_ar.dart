...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "AcheivementPercent":
            MessageLookupByLibrary.simpleMessage("نسبة المداومة"),
        ...
        "emptyHabits": MessageLookupByLibrary.simpleMessage(
            "لم تقم بإضافة اي عادات الى الآن، ابدأ رحلتك نحو الالتزام"),
        "endlish": MessageLookupByLibrary.simpleMessage("الإنجليزية"),
        "habitStartingDate":
            MessageLookupByLibrary.simpleMessage("تاريخ بداية العادة: "),
        "help": MessageLookupByLibrary.simpleMessage("المساعدة والاقتراحات"),
        ...
        "onboradingone":
            MessageLookupByLibrary.simpleMessage("أهلا بك في داوم"),
        "onboradingonedetail": MessageLookupByLibrary.simpleMessage(
            "داوم هو متتبع للعادات يمكنك من خلاله إنشاء عادات حسنة والمحافظة عليها، حيث يتيح لك نظرة شاملة لكل عادة وتاريخ الإنجاز."),
        "searchZikr": MessageLookupByLibrary.simpleMessage(
            "ما هي الأذكار التي تريد البحث عنها"),
